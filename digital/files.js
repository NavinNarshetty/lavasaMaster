module.exports = [
  ...
  // Languages
  'digital/js/languages/language.js',


  // Directives
  'digital/js/directives/directive.js',

  // Filters
  'digital/js/filters/filter.js',

  // Services
  'digital/js/services/template.js',
  'digital/js/services/errorService.js',
  'digital/js/services/knockoutService.js',
  'digital/js/services/configService.js',

  //Factories
  'digital/js/factories/navigation.js',
  'digital/js/factories/api.js',
  ...
  'digital/js/controllers/knockout-team.js',
  'digital/js/controllers/scorebasketball-controller.js',
