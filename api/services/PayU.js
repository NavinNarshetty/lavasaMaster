    ...
    schoolPayment: function (data, callback) {
        ...
        request.post({
            ...
            form: {
                ...
                surl: 'http://outsource.sfanow.in/api/payU/successErrorSchool',
                furl: 'http://outsource.sfanow.in/api/payU/successErrorSchool',
    ...
    atheletePayment: function (found, callback) {
        ...
        request.post({
            ...
            form: {
                ...
                surl: 'http://outsource.sfanow.in/api/payU/successErrorAthelete',
                furl: 'http://outsource.sfanow.in/api/payU/successErrorAthelete',
    ...
    additionalPayment: function (found, callback) {
        ...
        request.post({
            ...
            form: {
                ...
                surl: 'http://outsource.sfanow.in/api/payU/successError',
                furl: 'http://outsource.sfanow.in/api/payU/successError',
