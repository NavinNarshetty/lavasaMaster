            ...
            if (data.status == "success") {
                ...
                Registration.updatePaymentStatus(param, function (err, data) {
                    if (err) {
                        ...
                        res.redirect("http://outsource.sfanow.in/paymentSuccess");
                    ...
                    if (err) {
                        ...
                        Registration.remove({ //finds one with refrence to id
                            ...
                            if (err) {
                                ...
                                res.redirect("http://outsource.sfanow.in/paymentFailure");
                    ...
                    if (err) {
                        ...
                        Athelete.remove({ //finds one with refrence to id
                            ...
                            if (err) {
                                ...
                                res.redirect("http://outsource.sfanow.in/sorryAthelete");
