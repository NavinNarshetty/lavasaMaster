...
myApp.controller('StudentProfileCtrl', function ($scope, $filter, TemplateService, NavigationService, $timeout, $stateParams, $state, $window, $uibModal) {
    //Used to name the .html file
    ...
    $scope.template = TemplateService.getHTML("content/students-profile.html");
