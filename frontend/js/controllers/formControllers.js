...
myApp.controller('ChampionshipSchedulesCtrl', function ($scope, TemplateService, $state, NavigationService, $stateParams, toastr, $timeout, configService, $filter, $sce) {
    ...
    configService.getDetail(function (data) {
        ...
        $scope.getAllSchedule = function (data) {
            ...
            NavigationService.apiCallWithData($scope.url, $scope.constraints, function (data) {
                ...
                $scope.scheduleData = data.data.results;
